...
import processing.core.PImage;
    /**
     *@author iabin
     *ChessGUI extends PApplet
     */
public class ChessGUI extends PApplet {
    //Initialize of the variables-
    Position selected = null;
    ColorEnum turn = ColorEnum.WHITE;//Racist or not he whites go first

    int PIXEL_SIZE = 50;
    List<Position> legalMoves = new LinkedList<>();//initialize of the legalmoves
    Board board = Board.getInstance();//status of the board
    //initialize of the pieces
    PImage black_rook;
    PImage white_rook;
    PImage black_queen;
    PImage white_queen;
    ...
    public void settings() {
        size(400, 440);//size of the canvas
    }
    ...
    @Override
    public void draw() {
        drawBoard(); //The board is draw
        drawPosibleMoves(); //Posible moves
        writeTurn(); //Black or White
    }
