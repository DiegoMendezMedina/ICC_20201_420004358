--->Como compilar:
	 Desde la terminal ir a la dirección -/ICC/practica08/practica06/src$

y ejecutar :
	  -/ICC/practica08/practica06/src$ javac matriz/Matrix.java
	  -/ICC/practica08/practica06/src$ javac test/MatrxTests.java
...
y ejecutar:
      	 -/ICC/practica08/practica06/src$ java test/MatrixTests

	 *Con esto el programa se ejcuta


Paginas web que me sirvieron de ayuda :
